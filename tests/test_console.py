...
class TestCommand(unittest.TestCase):
    ...
    def test_create_fs(self):
        ...
        email = stor.all()[f'User.{result}'].email
        self.assertEqual(email, "cluck@wanadoo.fr")
        password = stor.all()[f'User.{result}'].password
        ...
        result = f.getvalue().strip()
        self.assertRegex(result, opt)
        johnny = stor.all()[f'State.{result}'].johnny
        self.assertEqual(johnny, "bravo")
        number = stor.all()[f'State.{result}'].number
        self.assertEqual(number, '7')
        pi = stor.all()[f'State.{result}'].pi
        ...
        result = f.getvalue().strip()
        self.assertRegex(result, opt)
        johnny = stor.all()[f'City.{result}'].johnny
        self.assertEqual(johnny, "bravo")
        number = stor.all()[f'City.{result}'].number
        self.assertEqual(number, '7')
        pi = stor.all()[f'City.{result}'].pi
        self.assertEqual(pi, '3.14')
        with patch('sys.stdout', new=io.StringIO()) as f:
        ...
        result = f.getvalue().strip()
        self.assertRegex(result, opt)
        johnny = stor.all()[f'Amenity.{result}'].johnny
        self.assertEqual(johnny, "bravo")
        number = stor.all()[f'Amenity.{result}'].number
        self.assertEqual(number, '7')
        pi = stor.all()[f'Amenity.{result}'].pi
        self.assertEqual(pi, '3.14')
        with patch('sys.stdout', new=io.StringIO()) as f:
        ...
        result = f.getvalue().strip()
        self.assertRegex(result, opt)
        johnny = stor.all()[f'Place.{result}'].johnny
        self.assertEqual(johnny, "bravo")
        number = stor.all()[f'Place.{result}'].number
        self.assertEqual(number, '7')
        pi = stor.all()[f'Place.{result}'].pi
        self.assertEqual(pi, '3.14')
        with patch('sys.stdout', new=io.StringIO()) as f:
        ...
        result = f.getvalue().strip()
        self.assertRegex(result, opt)
        johnny = stor.all()[f'Review.{result}'].johnny
        self.assertEqual(johnny, "bravo")
        number = stor.all()[f'Review.{result}'].number
        self.assertEqual(number, '7')
        pi = stor.all()[f'Review.{result}'].pi
        self.assertEqual(pi, '3.14')
        with patch('sys.stdout', new=io.StringIO()) as f:
